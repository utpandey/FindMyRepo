...
const Forks = ({data,i}) => {
    ...
    <div> 
        <List as='ol'>
            ...
            <List.Item as='li' className="pull_contents">Homepage Url : {homepageUrl ? homepageUrl : "Not Provided"}</List.Item>
            <List.Item as='li' className="pull_contents">License used : {nickname ? nickname : "Not Provided"}</List.Item>
